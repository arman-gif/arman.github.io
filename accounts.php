        ...
        <table class="table table-striped table-dark w-75 mx-auto">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo $userData['occupation']; ?></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><?php echo $userData['nid_number']; ?></td>
            </tr>
            <tr>
              <th scope="row">Nominee Name</th>
              <td><?php echo $userData['nname']; ?></td>
            </tr>
            <tr>
              <th scope="row">Nominee NID Numbe</th>
              <td><?php echo $userData['nnid']; ?></td>
            </tr>
            <tr>
