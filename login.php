...
<head>
	...
	<?php
	$con = new mysqli('localhost', 'root', '', 'royalbankdb');
	define('bankname', 'Royal Bank Ltd.');
	session_start();
...
<body style="background: url(images/banking_wp.jpg);background-size: 100%;">
	...
	<?php echo $error ?>
	<br>
	<div id="accordion" role="tablist" class="w-25 float-left shadowBlack" style="margin: 150px 0px 0px 70px">
		<br>
		<h4 class="text-center text-light">Select Your Session</h4>
		<div class="card rounded-0">
			...
			<div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
				<div class="card-body">
					<form method="POST">
						<input type="email" value="selim@gmail.com" name="email" class="form-control" required placeholder="Enter Email">
		...
		<div class="card rounded-0">
			...
			<h5 class="mb-0">
				<a  href="register_form.php"  class="collapsed btn btn-outline-primary btn-block" >Create New Account</a>
     		</h5>
			</div>
			</div>
		</div>
